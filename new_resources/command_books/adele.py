...
class Key:
    ...
    SKILL_R = 'r'   #Grave
    SKILL_T = 't'   #Ruin
    SKILL_A = 'a'   #Noble Summons
    SKILL_S = 's'   #Bloom
    SKILL_D = 'd'   #Hunting Decree
    SKILL_F = 'f'   #Plummet
    SKILL_5 = '5'   #Storm
    SKILL_6 = '6'   #Infinity Blade
    SKILL_END = 'end' #Reign
    ...
    if direction == 'left' or direction == 'right':
        ...
        if abs(d_x) >= 16:
            if abs(d_x) >= 60:
                ...
                if d_y == 0:
                    SkillCombination(direction='',jump='false',target_skills='skill_w|skill_e').execute()
                else:
